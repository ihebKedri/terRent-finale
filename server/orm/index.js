...
db.Reservation=require('../orm/models/reservationModel')(sequelize,DataTypes) // require the reservation model
...
db.Event.belongsToMany(db.Player,{through:"eventsHasPlayers",
as: "players",
foreignKey:"eventId"
})
